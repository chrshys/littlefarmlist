...
export default function Dashboard() {
  ...
  // Fetch own listings using the new API endpoint
  const { 
    data: myListings, 
    ...
    queryFn: () => apiRequest({ url: '/api/user/listings', method: 'GET' }),
  ...
  const deleteListingMutation = useMutation({
    ...
    onSuccess: () => {
      // Invalidate both the general listings query and the user listings query
                  ...
                  <Card key={listing.id} className="overflow-hidden hover:shadow-md transition-shadow">
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        {listing.items.slice(0, 3).map((item: any, index: number) => (
